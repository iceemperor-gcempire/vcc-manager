...
export const workboardAPI = {
  ...
  installNode: (serverId, installId) => api.post('/workboards/install-node', { serverId, installId }), // #609 P4
  installStatus: (serverId, uiId) => api.get('/workboards/install-status', { params: { serverId, uiId } }),
  rebootComfyUI: (serverId) => api.post('/workboards/reboot-comfyui', { serverId }),
...
export const jobAPI = {
  ...
  bulkDelete: (ids, deleteContent) => api.post('/jobs/bulk-delete', { ids, deleteContent }),   // #902
